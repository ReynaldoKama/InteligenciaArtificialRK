...
width = 10 #int(input("Introduzca el ancho del laberinto: "))
height = 10 #int(input("Introduzca el alto del laberinto: "))
obs = 20 #int(input("Introduzca la cantidad de obstaculos: "))
points = 1 #int(input("Numero de puntos: "))
